...
## 📌 Overview
Performed EDA on a weather dataset to analyze seasonal patterns, temperature trends, and extreme weather conditions. Added a Machine Learning model to forecast future temperatures.

## 📁 Dataset
Weather history dataset containing: Temperature, Humidity, Visibility, Pressure, Precipitation Type, Wind Speed, Date.
